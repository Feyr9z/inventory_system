...
<div class="row justify-content-center">
    <div class="col-lg-5 col-md-7">
        <div class="d-flex align-items-center gap-2 mb-4">
            ...
            <h3 class="fw-bold text-dark mb-0">Edit Nama Kategori</h3>
        </div>
            ...
            <form action="{{ route('inventory.kategori.update', $kategori->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="nama_kategori" name="nama_kategori" class="form-control border-start-0 ps-0 @error('nama_kategori') is-invalid @enderror" value="{{ old('nama_kategori', $kategori->nama_kategori) }}" required>
                    </div>
                    @error('nama_kategori')
                ...
                <div class="d-flex align-items-center justify-content-end gap-2 pt-2 border-top">
                    <a href="{{ route('inventory.kategori.index') }}" class="btn-app-secondary">
