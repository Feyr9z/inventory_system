...
<div class="row">
    <div class="col-md-6">
        <h2 class="page-title">📤 Input Barang Keluar</h2>
            ...
            <div class="card-body">
                <form action="{{ route('inventory.transaksi.keluar.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="tujuan" name="tujuan" class="form-control @error('tujuan') is-invalid @enderror" value="{{ old('tujuan') }}" placeholder="Misal: Departemen A, Customer XYZ" required>
                        @error('tujuan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
