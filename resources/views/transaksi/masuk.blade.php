...
@section('content')
<h2 style="color: #2c3e50; margin-bottom: 1rem;">Barang Masuk</h2>
...
<div class="card" style="max-width: 500px;">
    <form action="{{ route('inventory.transaksi.masuk.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" id="sumber" name="sumber" value="{{ old('sumber') }}" placeholder="Misal: Supplier A, Gudang Pusat" required>
            @error('sumber')
                <span style="color: #e74c3c; font-size: 0.85rem;">{{ $message }}</span>
            @enderror
        </div>
