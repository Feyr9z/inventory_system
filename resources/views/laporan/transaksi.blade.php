...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-2">
    <div>
        ...
        <p class="text-muted small mb-0">Rekapitulasi mutasi barang masuk & keluar, pelacakan alokasi FIFO, dan dokumen logistik</p>
    </div>
</div>
...
@if ($data)
            ...
            <div class="card-elevated p-3">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <small class="text-muted">Unit masuk pada periode ini</small>
                    </div>
            ...
            <div class="card-elevated p-3">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <small class="text-muted">Unit keluar pada periode ini</small>
                    </div>
    ...
    <!-- Modals Bagian Bawah (Di Luar Elemen Table Agar Tidak Merusak DOM) -->
    @foreach ($data as $idx => $item)
